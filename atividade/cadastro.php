...
<body style="background-color:">
	...
	<div class="container p4 box" style="padding: 5px;">
	
	
				<div class="col-md-6 p4" style="background-color: white; margin-left: 270px;">
						
						<h3 class="p10" style="font-size: 50px; font-family: arial">  Delivery food  <br/> </h3>
						
						<p class="p10 p3">  Para vender ou comprar cadastre-se inserindo os dados abaixo: </p>
						...
						<div class="form-group ">
							...
							<input name="cpf" class="form-control" placeholder="CPF, apenas números" type="text" maxlength="11">
						</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label for="endereço" class="sr-only">cidade</label>
							<input name="cidade" class="form-control" placeholder="Sua cidade" type="text">
						</div>
						...
						<div class="form-group">
							<label for="endereço" class="sr-only">Rua</label>
							<input name="rua" class="form-control" placeholder="Sua rua" type="text">
						</div>
					...
					<p class="texto" id="apagar"> 
						...
						<div class="form-group">
							...
							<a href="index.html"> <p class="cor"> Já tem uma conta?</p></a>
